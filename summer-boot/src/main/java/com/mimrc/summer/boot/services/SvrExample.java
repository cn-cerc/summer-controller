...
public class SvrExample extends DataService {
    private static final Logger log = LoggerFactory.getLogger(SvrExample.class);

    public DataSet search(IHandle handle, DataSet dataIn) {
        // 获取外部传进来的数据
        ...
        query.open();
        // 返回meta讯息
        FieldDefs columns = query.getFieldDefs();
